...
def light():
    while(not False):
        ...
        if "on" in choice:
            print("Bats fly over your head and you drop your lamp. \nNow you are on the dark. Would you go inside the cave or not?")
            while(not False):
                go=input('> ')
                if "yes" in go:
...
def start():
    ...
    while(not False):
        ...
        if "off" in choice:
            ...
            print("wrong answer, please answer on or off.")
